...
//        return citys?.count ?? 0
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        let str:[String:String] = citys?["cityInfo"] as! [String:String]
        cell.textLabel?.text = "\(str["parent"] ?? "")"
        cell.detailTextLabel?.text = "\(str["city"] ?? "")"
